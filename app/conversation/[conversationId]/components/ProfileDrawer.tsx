...
const ProfileDrawer: React.FC<ProfileDrawerProp> = ({
  ...
  return (
    <>
      <ConfirmModel isOpen={isModalOpen} onClose={() => setOpen(false)} />
                        ...
                        <div className="flex items-start justify-end">
                          <div className="ml-3 h-7 flex items-center">
                            <button
                              onClick={onClose}
                              type="button"
                              className="rounded-md text-gray-400 bg-white hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-200 focus:ring-offset-2"
                            >
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            <div
                              ...
                              className="flex flex-col gap-3 item-center cursor-pointer hover:opacity-50"
                            >
